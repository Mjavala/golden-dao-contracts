...
contract Gold1 is Initializable,UUPSUpgradeable,ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable,ERC20VotesCompUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(        
        ...
        ERC20Upgradeable.__ERC20_init("Gold 1", "GOLD 1");
        ERC20PermitUpgradeable.__ERC20Permit_init("Gold 1");
