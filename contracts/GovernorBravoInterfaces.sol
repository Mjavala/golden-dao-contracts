...
contract GovernorBravoEvents {
    ...
    /// @notice Emitted when the whitelistValar is set
    event WhitelistValarSet(address oldValar, address newValar);
...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the gold Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the gold governance token
    maiaInterface public maia;
